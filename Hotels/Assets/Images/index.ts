...
export const star_empty = require('./star_empty.png') // <a href="https://www.freepik.com/icon/star_1000874#fromView=search&term=yellow+star&page=1&position=22">Icon by Freepik</a>
...
export const map = require('./map.png') // <a href="https://www.freepik.com/icon/map_864272#fromView=search&term=map&page=1&position=35">Icon by pongsakornRed</a>
export const phone = require('./phone-call.png') // <a href="https://www.freepik.com/icon/phone-call_126509#fromView=search&term=phone+call&page=1&position=0">Icon by Gregor Cresnar</a>
export const email = require('./email.png') // <a href="https://www.freepik.com/icon/mail_1324171#fromView=search&term=email&page=1&position=41">Icon by Freepik</a>
export const radio_button_on = require('./radio_button_on.png')
export const radio_button_off = require('./radio_button_off.png')
